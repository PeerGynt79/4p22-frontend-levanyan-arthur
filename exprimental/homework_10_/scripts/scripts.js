...
.then((info) => {
  console.log('-----------'); console.log('Пункт №1:'); console.log('-----------');
  ...
  console.log('-----------'); console.log('Пункт №2:'); console.log('-----------');
  for(let entry of info.data) {
    console.log(entry.last_name);
  };
  
  console.log('-----------'); console.log('Пункт №3:'); console.log('-----------'); 
  ...
  console.log('-----------'); console.log('Пункт №4:'); console.log('-----------');
  ...
  console.log('-----------'); console.log('Пункт №5:'); console.log('-----------');
